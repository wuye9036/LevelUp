...
def CreateAbsChgViewerModel(modelName):
	if modelName == "WSM":
		return WSMAbsChgViewerModel()
	if modelName == "WPM":
		return WPMAbsChgViewerModel()
	
class AbsChgViewerModel(QtCore.QAbstractTableModel):
	...
	def data(self, index, role):
		...
		return QtCore.QVariant(str(self.chgMat_.AbstractCriteriaChangeMatrix()[(hiRank, lowRank)][col - 2]))
...
class WSMAbsChgViewerModel(AbsChgViewerModel):
	def __init__(self, parent = None):
		AbsChgViewerModel.__init__(self, parent)
...
class WPMAbsChgViewerModel(AbsChgViewerModel):
	def __init__(self, parent = None):
		AbsChgViewerModel.__init__(self, parent)
